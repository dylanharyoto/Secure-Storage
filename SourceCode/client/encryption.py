...
aes_key, hmac_key = CryptoHandler.encrypt_file(b"correctpassword", "example.txt", "encrypted.bin")

try:
    CryptoHandler.decrypt_file(b"correctpassword", "encrypted.bin", "decrypted.txt", aes_key, hmac_key)
